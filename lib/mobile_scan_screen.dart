...
import 'package:sensors_demo/scanner_error_widget.dart';

@RoutePage()
class MobileScanScreen extends StatefulWidget {
  const MobileScanScreen({Key? key}) : super(key: key);

  @override
  _MobileScanScreenState createState() => _MobileScanScreenState();
}
