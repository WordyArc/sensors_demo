...
@RoutePage()
class WifiScanDemoScreen extends StatefulWidget {
  /// Default constructor for [WifiScanDemoScreen] widget.
  const WifiScanDemoScreen({Key? key}) : super(key: key);

  @override
  State<WifiScanDemoScreen> createState() => _WifiScanDemoScreenState();
}

class _WifiScanDemoScreenState extends State<WifiScanDemoScreen> {
