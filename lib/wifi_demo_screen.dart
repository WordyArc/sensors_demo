...
@RoutePage()
class WifiDemoScreen extends StatefulWidget {
  @override
  _WifiDemoScreenState createState() => _WifiDemoScreenState();
}

class _WifiDemoScreenState extends State<WifiDemoScreen> {
